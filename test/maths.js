...
const {VMChunk, Opcode, encodeString, encodeFloat, encodeArray, encodeArrayRegisters} = require("../src/utils/assembler");
...
chunk.append(new Opcode("LOAD_STRING", 3, encodeString("append")));
...
chunk.append(new Opcode("FUNC_CALL", 4, registers.VOID, 2, encodeArrayRegisters([0, 1])));
